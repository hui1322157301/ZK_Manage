  ...
  <body background="/ZK_Manage/img/frame_right.jpg" class="frame_right_bj" >
  	<div align="center" id="check_div1" >
  		...
  		<table align="center" border="1px" style="text-align: center; border-collapse: collapse;">
  			...
  			<tr>
  				<form action="<%=request.getContextPath() %>/BackstageRelayServlet" method="post" id="relay_form" >
  					<td><input type="date" id="begin_time" name="begin_time" /></td>
	  				<td><input type="date" id="end_time" name="end_time" /></td>
	  				<td><input type="text" id="relay_sname" name="relay_sname" /></td>
  				</form>
  			</tr>
  		</table>
  		<br/><input type="button" value="查询" onclick="check3()" />
  	</div>
  	<div align="center" id="check_div2" >
  		<table align="center" border="1px" style="text-align: center; border-collapse: collapse;">
  			...
  			<c:forEach items="${requestScope.rmlist }" var="rm" >
	  			<tr>
	  				<td>${rm.sname }</td>
	  				<td>${rm.prename }</td>
	  				<td>${rm.workdate }</td>
  	...
  	<script type="text/javascript">
    	function check3(){
    		...
    		var relay_form = document.getElementById("relay_form");
